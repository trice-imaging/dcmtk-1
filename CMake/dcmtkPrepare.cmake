...
ADD_DEFINITIONS(-DDCMTK_BUILD_DATE=\\\"2014-06-17\\\")
...
MACRO(GET_GXX_VERSION VERSION)
  EXECUTE_PROCESS(COMMAND ${CMAKE_CXX_COMPILER} -dumpversion OUTPUT_VARIABLE ${VERSION})
  STRING(STRIP ${${VERSION}} ${VERSION})
ENDMACRO(GET_GXX_VERSION VERSION)

MACRO(GET_CLANG_VERSION VERSION)
...
ENDMACRO(GET_CLANG_VERSION VERSION)

MACRO(ALLOW_CXX11_SUPPORT FLAGS)
  IF(DCMTK_USE_CXX11_STL)
    MESSAGE(STATUS "Info: Building DCMTK with enabled C++11 support.")
...
MACRO(DENY_CXX11_SUPPORT)
  IF(DCMTK_USE_CXX11_STL)
    IF(DCMTK_CXX11_FLAGS AND NOT DCMTK_CXX11_FLAGS STREQUAL "unknown")
      ...
      SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${DCMTK_CXX11_FLAGS}")
    ELSE()
      MESSAGE(WARNING "DCMTK has been configured to use the C++11 STL, but compiler does not seem to support C++11. Override this warning by setting DCMTK_CXX11_FLAGS to tell DCMTK how to enable C++11 support for your compiler.")
...
ELSEIF("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
  GET_CLANG_VERSION(CLANG_VERSION)
